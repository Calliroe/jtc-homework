...
//        Задача 5. Найти самых старых сотрудников в каждой стране
        ...
        Optional<Employee> optionalEmployee = employeeList.stream().min(Comparator.comparing(Employee::getAge));
        System.out.println("Список самых молодых сотрудников: ");
        employeeList.stream().
                filter(employee -> employee.getAge().equals(optionalEmployee.get().getAge())).
        ...
        Map<Country, Optional <Employee>> map5 = employeeList.stream().
