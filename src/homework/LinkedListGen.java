...
public class LinkedListGen<E> implements List<E> {
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        ...
        LinkedListGen<E> list = new LinkedListGen<>();
    ...
    class ListItr implements ListIterator<E> {
        ...
        public void remove() {
            ...
            LinkedListGen.this.remove(current);
            if (next == current)
                next = willNext;
            else
                nextIndex--;
        ...
        public void add(E e) {
            current = null;
            if (next == null) LinkedListGen.this.add(size, e);
            else LinkedListGen.this.add((nextIndex), e);
            nextIndex++;
        }
    }
